...
TARGET_PREBUILT_KERNEL := device/UMI/Rome/kernel
...
# File Systems
TARGET_RECOVERY_FSTAB = device/UMI/Rome/fstab.recovery
...
# Turn the screen upside down for UMI M2 Note to make TWRP usable
...
BOARD_CUSTOM_BOOTIMG_MK := device/UMI/Rome/custombootimg.mk
